 ...
 */
public class ReflectionSubfilter implements SubFilter{
    ...
    public void setTag(Object tag) {
        ReflectionSubfilter.tag = (String) tag;
    }
  ...
  //  public Bitmap process(Bitmap inputImage)
    ...
    public Bitmap process2(Bitmap inputImage) {
        // create new bitmap with the same settings as source bitmap
        Bitmap bmOut = Bitmap.createBitmap(inputImage.getWidth(), inputImage.getHeight(), inputImage.getConfig());
        // color info
        int A, R, G, B;
        int pixelColor;
        // image size
    ...
    public Bitmap gaussBlur(Bitmap inputImage) {
        ...
        convMatrix.Offset = 0;
        return ConvolutionMatrix.computeConvolution3x3(inputImage, convMatrix);
    }
    ...
    public Bitmap process(Bitmap inputImage) {
        ...
        Bitmap reflectionImage = Bitmap.createBitmap(inputImage, 0, height/2, width, height/2, matrix, false);
        ...
        Paint paint = new Paint();
        LinearGradient shader = new LinearGradient(0, inputImage.getHeight(), 0,
