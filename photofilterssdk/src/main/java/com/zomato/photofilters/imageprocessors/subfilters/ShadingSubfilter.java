 ...
 */
public class ShadingSubfilter implements SubFilter{

    private static String tag = "";
    private Context context;
    private int shadingColor;

    public ShadingSubfilter(int color){
    ...
    public void setTag(Object tag) {
        ShadingSubfilter.tag = (String) tag;
    }
  //  public Bitmap process(Bitmap inputImage)
    ...
    public Bitmap mirror(Bitmap inputImage) {
