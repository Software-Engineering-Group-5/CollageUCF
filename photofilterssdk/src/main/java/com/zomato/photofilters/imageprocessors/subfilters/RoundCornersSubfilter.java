 ...
 */
public class RoundCornersSubfilter implements SubFilter{
    ...
    public void setTag(Object tag) {
        RoundCornersSubfilter.tag = (String) tag;
    }
  //  public Bitmap process(Bitmap inputImage)
    ...
    public Bitmap GaussianFilter(Bitmap inputImage) {
    ...
    public Bitmap process(Bitmap inputImage) {
        ...
        canvas.drawBitmap(inputImage, rect, rect, paint);
